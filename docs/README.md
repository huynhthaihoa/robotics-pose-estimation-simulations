...
[`use_numpy/`](../use_numpy/) and [`use_manif/`](../use_manif/). Grouped by role below; within
each group, docs are listed in a sensible reading order (later ones lean on earlier ones).
